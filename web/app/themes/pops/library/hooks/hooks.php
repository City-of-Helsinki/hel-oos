 ...
 *
 * @hook pops_after_body
 */
add_action( 'pops_after_body', function () {
    $options = get_option( 'pops_general_options' );

    if ( ! empty( $options['pops_tagmanager'] ) ) :
        echo $options['pops_tagmanager'];
    endif;
} );
