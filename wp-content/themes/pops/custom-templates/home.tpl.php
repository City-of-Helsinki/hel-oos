...
$aboutPageId = get_field('about_page_link');

$aboutPageUrl = $aboutPageId ? get_permalink($aboutPageId) : '/hanke';
...
<section class="row main-container text-center">
    <div class="header-container">
        ...
        <div class="header__links">
            <a href="#" target="_blank" class="button button--header-link" data-toggle="modal"
               data-target="#videoModal">
                <i class="fa fa-play" aria-hidden="true"></i>
                <span>Katso esittelyvideo</span>
            </a><!--
      --><a class="button button--header-link" href="<?php echo $aboutPageUrl ?>">
...
<main class="home">
    <section class="home__links">
        ...
        <a class="button button--section-link pull-right" href="<?php echo $blogPageUrl ?>">
